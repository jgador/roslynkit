...
The separate [.agents/skills/commit-context/SKILL.md](../../.agents/skills/commit-context/SKILL.md), [.agents/skills/git-commit-push/SKILL.md](../../.agents/skills/git-commit-push/SKILL.md), [.agents/skills/security-audit/SKILL.md](../../.agents/skills/security-audit/SKILL.md), [.agents/skills/benchmark/SKILL.md](../../.agents/skills/benchmark/SKILL.md), and [.agents/skills/dotnet-tool-release/SKILL.md](../../.agents/skills/dotnet-tool-release/SKILL.md) files are standalone repo workflow skills. They maintain ignored local commit notes, commit from that prepared context, run read-only repository security audits, run explicitly requested native raw-text versus RoslynKit text-only benchmarks, and prepare a locally tested NuGet upload candidate with opt-in global installation without publishing it. They are not part of the stable/dev RoslynKit command-skill pair, do not need to mirror either RoslynKit skill, and must not be added to the `roslynkit init` bundle.
...
- [.agents/skills/dotnet-tool-release/SKILL.md](../../.agents/skills/dotnet-tool-release/SKILL.md) is the explicit-only, repo-specific release preparation and local dogfooding workflow. It owns ordered multi-action orchestration and safe same-invocation phase reuse. [scripts/prepare-roslynkit-package.ps1](../../scripts/prepare-roslynkit-package.ps1) owns the folder-feed build, [scripts/test-roslynkit-commands.ps1](../../scripts/test-roslynkit-commands.ps1) owns exhaustive command coverage, aggregated failure reporting, and the copy-ready manual checklist, [scripts/test-roslynkit-package.ps1](../../scripts/test-roslynkit-package.ps1) owns isolated package installation, and [scripts/install-roslynkit-global.ps1](../../scripts/install-roslynkit-global.ps1) plus [scripts/test-roslynkit-global.ps1](../../scripts/test-roslynkit-global.ps1) own explicit global replacement and verification. Keep [docs/dotnet-tool-release.md](../dotnet-tool-release.md) authoritative, keep public upload separate, and never make global replacement part of the default `ready` action.
...
- option requirements and defaults such as implicit repository scope or `--file`, `--project`, `--tfm`, and `--document-kind`;
