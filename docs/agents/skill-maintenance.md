...
- [docs/dotnet-tool-release.md](../dotnet-tool-release.md) owns release preparation, the grouped manual Bash checklist, explicit global replacement, and the separate manual NuGet.org upload. There is no release workflow skill. [scripts/pack.ps1](../../scripts/pack.ps1) owns the folder-feed build, [scripts/common/packaging.ps1](../../scripts/common/packaging.ps1) owns shared isolated installation and package-hash validation, and [scripts/test-commands.ps1](../../scripts/test-commands.ps1) owns automated command coverage. [scripts/test-package.ps1](../../scripts/test-package.ps1) tests the isolated installation, while [scripts/install-global.ps1](../../scripts/install-global.ps1) and [scripts/test-global.ps1](../../scripts/test-global.ps1) own explicit global replacement and verification. Update the guide's manual examples alongside changes to runtime commands or fixture coordinates; keep public upload separate from local preparation.
