...
- [.agents/skills/benchmark/SKILL.md](../../.agents/skills/benchmark/SKILL.md) is a standalone repo workflow skill for explicit clean-room Codex benchmark requests. Keep it outside the stable RoslynKit bundle so `roslynkit init` does not scaffold it.
