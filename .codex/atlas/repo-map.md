...
- `GitWorktreeFingerprintService` performs the request-time stable `HEAD` / raw porcelain / per-file `hash-object --no-filters` capture, coalesces concurrent callers, and returns deterministic structural fingerprints or typed cache-reuse failures. It is a pre-session seam and is not routed from CLI commands yet.
...
- Daemon identity foundation: [GitWorkspaceIdentityResolver.cs](../../src/RoslynKit/GitWorkspaceIdentityResolver.cs), [GitWorkspaceIdentity.cs](../../src/RoslynKit/GitWorkspaceIdentity.cs), [RoslynKitBuildInfo.cs](../../src/RoslynKit/RoslynKitBuildInfo.cs), [ProcessCommandRunner.cs](../../src/RoslynKit/ProcessCommandRunner.cs); start symbol `GitWorkspaceIdentityResolver.ResolveAsync`; tests [GitWorkspaceIdentityResolverTests.cs](../../tests/RoslynKit.Tests/GitWorkspaceIdentityResolverTests.cs). This seam does not yet participate in public command routing.
