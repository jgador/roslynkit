...
- `ProcessCommandRunner` is the argument-list-only, buffered child-process boundary used by workspace identity probes; Git fingerprinting can reuse it without invoking a shell.
