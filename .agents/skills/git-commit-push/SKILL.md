...
This RoslynKit skill is intentionally narrower than the global workflow: do not draft a new commit message during commit/push. Use the prepared [artifacts/commit-context.md](../../../artifacts/commit-context.md) file as the commit message.
...
2. Validate [artifacts/commit-context.md](../../../artifacts/commit-context.md) before staging:
   ...
   - if the file is missing, empty, or obviously stale, stop and refresh it with [.agents/skills/commit-context/SKILL.md](../commit-context/SKILL.md) before committing
...
- Default to [artifacts/commit-context.md](../../../artifacts/commit-context.md) as the only commit message source.
