...
<!-- This file is generated by `dotnet run --file .\tools\RoslynKit.CommandDocs.cs -- --write`. Do not edit by hand. -->

Generated from RoslynKit built-in command metadata at package build time.

This reference lists the runtime command metadata used by parser binding and help output. For emitted `id:` values and documentation-comment ID prefix meanings, see [.agents/skills/roslynkit/references/output.md](output.md). Agent routing guidance remains in [.agents/skills/roslynkit/SKILL.md](../SKILL.md).
