...
public static class CommandReferenceMarkdown
{
    ...
    public static string Render()
    {
        ...
        AppendLine(builder);
        AppendLine(builder, "Generated from RoslynKit built-in command metadata at package build time.");
        AppendLine(builder);
        AppendLine(builder, "This reference lists the runtime command metadata used by parser binding and help output. For emitted `id:` values and documentation-comment ID prefix meanings, see [.agents/skills/roslynkit/references/output.md](output.md). Agent routing guidance remains in [.agents/skills/roslynkit/SKILL.md](../SKILL.md).");
        AppendLine(builder);
